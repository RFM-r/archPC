# Список работ:
## [ 1-ая лабораторная работа по ВиПКС ](/ISCS/Lect2LabWork1/table.md)

## [ 2-ая лабораторная работа по ВиПКС ](/ISCS/Lect3LabWork2/HardDrive.md)

## [ 3-ая лабораторная работа по ВиПКС ](/ISCS/Lect4LabWork3/diagnostics.md)
